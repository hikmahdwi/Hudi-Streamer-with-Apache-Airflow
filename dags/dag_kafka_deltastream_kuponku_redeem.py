...
PROPERTIES_FILE_PATH = "/opt/airflow/jobs/configs/kafka-hudi-kuponku-redeem.properties"
# JARS_FILE_PATH = "/opt/airflow/jobs/jar/hudi-transformer-tes-1.0.0.jar"
...
with DAG(   
    ...
    ingest_task = SparkSubmitOperator(  
        ...
        application_args=[
            ...
            '--op', 'UPSERT',
            # '--transformer-class', 'com.aptana.hudi.transform.HudiAddKeysTransformer',
            '--enable-hive-sync',
        ]
    )
